...
public class GameController {
    ...
    public ResponseEntity<Results> attack(@RequestBody UserLoginDTO userLoginDTO, @PathVariable String opponent) throws ExecutionException, InterruptedException {
        CompletableFuture<Results> results = gameService.attack(userLoginDTO.getUsername(),opponent);
        if(results==null){
